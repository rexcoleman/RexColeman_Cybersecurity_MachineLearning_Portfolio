...
You know how engineers struggle with defining a customer problem and understanding a business need?  They love to build cool widgets that are destined to fail in the market (reference that famous computer story).  A commonly understand career path for engineers is to start technical and move into nontechnical leadership roles as they mature.   The reverse transition, from nontechnical to technical is 10X more valuable. 

Sales forced me to understand the customer.  As a proud geek to my inner core, I went to great lengths, that most sales repos wouldn’t, to accomplish this.  From earning an MBA and a CFA  to studying the nuances of rhetorc from the ancient romans to crying at a microphone in front of 200 people in a transformation seminar I turned over every possible stone I could find.  I was successful: I crushed my target by over 200%.   Sales is not the best use of my talents.  This process forged my nurture my superpower.

My super power is that I interpret and simplify really complex topics to disrupt industries.  Data science is a complex topic.  Computer science is a complex topic.  Cybersecurity is a complex topic.  Technological innovation and understanding where the puck is going is a complex topic.  As is business.  My core value proposition that I simplify and connect these concepts in a way that very few people can.  From the electron level of detail to malware anomaly detection  to business model strategy all the way up to  human nature philosophy. 

I can and will code and will be a kid in a candy store doing it.   I am not a fit for a round peg in a round hole.  If you are looking to establish industry leadership, I just might be your unicorn.
...
:---------------------------------------------------: | :---------------------------------------------------:
<img src="img/CRISP-DM_Process_Diagram.png" alt="CRISP-DM" width="400"> | <img src="img/variable_importance.png" alt="Feature Importance" width="415">
...
:---------------------------------------------------: | :---------------------------------------------------:
<img src="img/html_table.png" alt="HTML Table Target" width="400"> | <img src="img/dratframe_created_from_webscraping.png" alt="Beautiful Soup Result" width="528">
